...
md"""
Since the rate of growth is constant, $P$ always changes by the same amount in a certain amount of time, regardless of how much time has already passed. Thus the graph of $P$ versus $t$ is a straight line that intersects the y-Axis at $P_0$ and grows with a slope of $r$.
"""
...
md"""
### Into the Dragon's Den - Deriving an Analytic solution
...
manifest_format = "2.0"
project_hash = "0c370a62f569af3162263061d48d966fb78ef3fc"
